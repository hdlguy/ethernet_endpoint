...
int main(int argc, char *argv[])
{
    ...
    printf("mac address = "); for(int i=0; i<6; i++) { printf("%02x", ((uint8_t *)&if_mac.ifr_hwaddr.sa_data)[i]); } printf("\n");
    ...
    printf("shost = "); for(int i=0; i<6; i++) { printf("0x%02x, ", eh->ether_shost[i]); } printf("\n");
    printf("dhost = "); for(int i=0; i<6; i++) { printf("0x%02x, ", eh->ether_dhost[i]); } printf("\n");
